...
//        TriviaManager triviaManager = new TriviaManager(triviaFile);
//
...
//                TriviaQuestion triviaQuestion = triviaManager.getQuestion(i);
//                String questionText = triviaQuestion.getQuestion();
//                String correctAnswer = triviaQuestion.getAnswer();
//                String[] possibleAnswers = triviaQuestion.getPossibleAnswers();
//
